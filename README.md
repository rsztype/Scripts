...
Each script is a single `.py` file at the top level here, so they all sit
together in one flat *Script* menu once installed.

## License

Copyright 2026 Giuseppe Salerno / Resistenza Type (rsztype.com) — free to use, modify, and distribute, provided as-is. See [LICENSE.txt](LICENSE.txt).
